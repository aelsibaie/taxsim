...
ax.plot(
    ...
    current_law_df["avg_effective_tax_rate_wo_payroll"],
    drawstyle='steps-pre',
    label='Current Law'
)
ax.plot(
    house_2018_df["gross_income"],
    house_2018_df["avg_effective_tax_rate_wo_payroll"],
    drawstyle='steps-pre',
    label='House 2018 Proposal'
)
ax.plot(
    senate_2018_df["gross_income"],
    senate_2018_df["avg_effective_tax_rate_wo_payroll"],
    drawstyle='steps-pre',
